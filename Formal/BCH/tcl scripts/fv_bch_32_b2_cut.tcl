...
read_verilog -golden -version sv2012 [subst {
    $design_path/64B/memory_wrapper_32_64_b2.sv
    $design_path/64B/SRAM.v
    $design_path/64B/bch_dec_encoder.sv
    $design_path/64B/bch_dec_decoder.sv
...
set_cut_signals {memory_wrapper.u_sram.din0 memory_wrapper.encoder_inst.data_i}

cut_signals {memory_wrapper.u_sram.din0 memory_wrapper.encoder_inst.data_i}
...
read_sva -version sv2012 [subst {
    $property_path/64B/memory_wrapper_fv_32_2b_cut.sv
}]
