...
logic [ADDR_WIDTH-1:0] fv_addr_base;
    ...
    property p_word_packing_error;
        ...
        ##1 ( !pi_cen && pi_wen && pi_addr == fv_addr_base + WORDS_BLOCK - 1 && fv_ecc_enc_data == memory_wrapper_32_B2.sram_dout[DATA_WIDTH*WORDS_BLOCK-1:0])[*2]
		|->
		po_q == fv_data_in
        //&& po_err_corr
	;endproperty
    ...
    && !pi_wen
    |->
    {fv_ecc_enc_data, memory_wrapper_32_B2.encoder_inst.V_out, memory_wrapper_32_B2.encoder_inst.H_out} == {fv_data_in_pack,check_bits}
    ;endproperty
...
logic [CHECK_H_WIDTH+CHECK_V_WIDTH-1:0] check_bits;
    ...
    bind memory_wrapper_32_B2 memory_wrapper_fv #(
