...
read_verilog -golden -version sv2012 [subst {
    $design_path/dmc_sram_wrapper_32Bit_B2.sv
    $design_path/SRAM.v
...
####################
# Elaborate Design #
set_elaborate_option -golden -top memory_wrapper_32_B2
elaborate     -golden 
...
set_cut_signals {memory_wrapper_32_B2.u_sram.din0 memory_wrapper_32_B2.encoder_inst.D}

cut_signals {memory_wrapper_32_B2.u_sram.din0 memory_wrapper_32_B2.encoder_inst.D}



read_sva -version sv2012 [subst {
    $property_path/fv_dmc_memory_wrapper_32_B2_cut.sv
}]
