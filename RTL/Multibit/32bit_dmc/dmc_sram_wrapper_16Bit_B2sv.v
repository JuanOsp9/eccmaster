module memory_wrapper #(
	...
	dmc_codec_32bit #(
        ...
        .En     (wen),
        .D (wen? d_ram : sram_dout[DATA_WIDTH-1:0]),
		.H_read (sram_dout[CHECK_H_WIDTH-1:DATA_WIDTH]),
		.V_read (sram_dout[CHECK_V_WIDTH-1:DATA_WIDTH+CHECK_H_WIDTH]),
		.H_out  (codec_h_out),
		.V_out  (codec_v_out)
	...
	dmc_locator_corrector_32bit #(
        ...
        .D_in       		(sram_dout[CHECK_H_WIDTH-1:DATA_WIDTH]),
        .delta_H           	(codec_h_out),
        .S 					(codec_v_out),
        .D_out   			(q_out),
