...
read_verilog -golden -version sv2012 [subst {
    $design_path/dmc_sram_wrapper_16Bit_B2.sv
    $design_path/SRAM.v
    $design_path/dmc_locator_corrector_32bit.sv
    $design_path/dmc_codec_32bit.sv
...
####################
# Elaborate Design #
set_elaborate_option -golden -top memory_wrapper_16bit_B2
elaborate     -golden 
...
set_cut_signals {memory_wrapper_16bit_B2.u_sram.din0 memory_wrapper_16bit_B2.encoder_inst.D}

cut_signals {memory_wrapper_16bit_B2.u_sram.din0 memory_wrapper_16bit_B2.encoder_inst.D}



read_sva -version sv2012 [subst {
    $property_path/fv_dmc_memory_wrapper_16_B2_cut.sv
}]
