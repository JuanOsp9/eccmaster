...
read_verilog -golden -version sv2012 [subst {
    $design_path/32B/memory_wrapper_16_32_b2.sv
    $design_path/32B/SRAM.v
    $design_path/32B/bch_dec_encoder.sv
    $design_path/32B/bch_dec_decoder.sv
...
read_sva -version sv2012 [subst {
    $property_path/32B/memory_wrapper_fv_16_2b_cut.sv
}]
