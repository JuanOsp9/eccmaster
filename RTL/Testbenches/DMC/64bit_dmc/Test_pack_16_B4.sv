  ...
  memory_wrapper_16_B4 #(
    ...
    task read_word(input int target_addr);
        begin
            ...
            // 3. Sample
            #1; 
            $display("[%0t] Read Addr: %0d | Data: %h | S_ERR: %b | D_ERR: %b", 
                     $time, target_addr, q, single_bit_corrected, double_bit_error);
