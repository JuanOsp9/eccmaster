module memory_wrapper_32_B2 #(
    parameter int ADDR_WIDTH 		= 7,
    parameter int DATA_WIDTH 		= 32,
    parameter int CHECK_H_WIDTH 	= 24,
	parameter int CHECK_V_WIDTH 	= 16,
    parameter int CODE_WIDTH	 	= 104,  // DATA*2 + CHECK_H + CHECK_V
	...
	dmc_codec_64bit #(
		...
		.V_read (sram_dout[TOTAL_WIDTH - 1:TOTAL_WIDTH-CHECK_V_WIDTH]),
		.H_out  (codec_h_out),
		.V_out  (codec_v_out)
